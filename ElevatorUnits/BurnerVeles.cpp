...
BurnerVeles::BurnerVeles( int ID,
    ...
    :Unit( Prom::TypeBurner,
           ...
           Prom::UnMdStop )
{
    _setT = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка t°C", ".setTemp", false, false, false, true, Prom::VCdiv10, true );

    _T = new InETag( this, Prom::TpIn, "Датчик t°C", ".temp", true, 90, 5, false, false, true, false, true, Prom::VCdiv10 );
