                ...
                SaveMode )
{
    ...
    connect( _HL, &InDiscretETag::Detected,   this, &Silos2::ActivateHL,   Qt::QueuedConnection );
    connect( _HL, &InDiscretETag::Undetected, this, &Silos2::DeactivateHL, Qt::QueuedConnection );
    ...
    connect( _LL, &InDiscretETag::Detected,   this, &Silos2::ActivateLL,   Qt::QueuedConnection );
    connect( _LL, &InDiscretETag::Undetected, this, &Silos2::DeactivateLL, Qt::QueuedConnection );
