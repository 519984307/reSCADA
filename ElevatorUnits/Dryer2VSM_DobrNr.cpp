...
//    _outHumidity  = new InETag(this, TpIn, "Вых. влагомер", ".humOut", false, 1000, 5, false, false, false, false, true, VCFloatInIntToDouble);
    ...
    _T1 = new InETag( this, Prom::TpIn, "Датчик t°C 1", ".T1", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T1->needBeUndetectedAlarm();
    _T2 = new InETag( this, Prom::TpIn, "Датчик t°C 2", ".T2", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T2->needBeUndetectedAlarm();
    _T3 = new InETag( this, Prom::TpIn, "Датчик t°C 3", ".T3", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T3->needBeUndetectedAlarm();
    _T4 = new InETag( this, Prom::TpIn, "Датчик t°C 4", ".T4", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T4->needBeUndetectedAlarm();
    _T5 = new InETag( this, Prom::TpIn, "Датчик t°C 5", ".T5", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T5->needBeUndetectedAlarm();
    _T6 = new InETag( this, Prom::TpIn, "Датчик t°C 6", ".T6", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T6->needBeUndetectedAlarm();
    _T7 = new InETag( this, Prom::TpIn, "Датчик t°C 7", ".T7", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T7->needBeUndetectedAlarm();
    _T8 = new InETag( this, Prom::TpIn, "Датчик t°C 8", ".T8", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T8->needBeUndetectedAlarm();
    _T9 = new InETag( this, Prom::TpIn, "Датчик t°C 9", ".T9", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T9->needBeUndetectedAlarm();
    _T10 = new InETag( this, Prom::TpIn, "Датчик t°C 10", ".T10", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T10->needBeUndetectedAlarm();
    _T11 = new InETag( this, Prom::TpIn, "Датчик t°C 11", ".T11", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T11->needBeUndetectedAlarm();
    _T12 = new InETag( this, Prom::TpIn, "Датчик t°C 12", ".T12", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T12->needBeUndetectedAlarm();
    _T13 = new InETag( this, Prom::TpIn, "Датчик t°C 13", ".T13", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T13->needBeUndetectedAlarm();
    _T14 = new InETag( this, Prom::TpIn, "Датчик t°C 14", ".T14", true, 30, 5, false, false, false, true, true, Prom::VCFloatInIntToDouble );
    _T14->needBeUndetectedAlarm();
    _T15 = new InETag( this, Prom::TpIn, "Датчик t°C 15", ".T15", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T15->needBeUndetectedAlarm();
    _T16 = new InETag( this, Prom::TpIn, "Датчик t°C 16", ".T16", true, 30, 5, false, false, false, false, true, Prom::VCFloatInIntToDouble );
    _T16->needBeUndetectedAlarm();

    ///отключить потом
    setT1    = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка порога t°C 1",  ".setT1",  false, false, false, true, Prom::VCFloatInIntToDouble, true);
    setT2    = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка порога t°C 2",  ".setT2",  false, false, false, true, Prom::VCFloatInIntToDouble, true);
    setT3    = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка порога t°C 3",  ".setT3",  false, false, false, true, Prom::VCFloatInIntToDouble, true);
    setT4    = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка порога t°C 4",  ".setT4",  false, false, false, true, Prom::VCFloatInIntToDouble, true);
    setT5    = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка порога t°C 5",  ".setT5",  false, false, false, true, Prom::VCFloatInIntToDouble, true);
    setT6    = new OutETag( this, Prom::TpOut, Prom::PreSet, "Уставка порога t°C 6",  ".setT6",  false, false, false, true, Prom::VCFloatInIntToDouble, true);
