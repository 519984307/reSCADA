               ...
               Prom::UnMdStop)
{
    ...
    //    _ignorTRM = new OutDiscretETag(this, Prom::PreSet, "Игнор аварии ТРМ", ".ignoreTRM", true, false);
...
void BurnerVSM_Kromy::_setCurrentState(UnitStates CurrentState)
{
    ...
    case UnStCollingStopCommand:
    case UnStStopCommand :  emit s_stopComand(); break;
    case UnStColling :
    case UnStCollingStoped:
